    ...
    <header
        ...
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between border-b border-slate-200/60 bg-white/95 backdrop-blur-md">
                        ...
                        <div class="bg-white border border-slate-100 shadow-xl rounded-xl w-64 py-2 flex flex-col">
                            ...
                            <div class="relative group/nested w-full">
                                ...
                                <div
                                    class="absolute top-0 left-full pl-2 opacity-0 invisible group-hover/nested:opacity-100 group-hover/nested:visible transition-all duration-200 transform origin-top-left">
                                    <div
                                        class="bg-white border border-slate-100 shadow-xl rounded-xl w-72 py-2 flex flex-col">
                                        <a href="#"
                                            class="px-5 py-2.5 text-sm text-slate-600 hover:text-[#005DAA] hover:bg-slate-50">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="#"
                    class="flex items-center justify-center px-5 py-2 text-sm font-medium text-white bg-[#005DAA] hover:bg-[#F7A81B] rounded-lg shadow-sm hover:shadow-md transition-all">
                    Donate
                </a>
                <!-- Mobile Menu Toggle -->
        ...
        <div id="mobile-menu"
            class="hidden lg:hidden bg-white border-t border-slate-100 absolute top-20 left-0 right-0 shadow-xl max-h-[85vh] overflow-y-auto z-40">
            <nav class="flex flex-col p-6 space-y-4">
                    ...
                    <div class="flex flex-col pl-4 mt-2 space-y-2 border-l-2 border-slate-100">
                        ...
                        <details class="group/nested mt-1">
                            ...
                            <div class="flex flex-col pl-4 mt-1 space-y-2 border-l-2 border-slate-100">
                                <a href="president-message.html" class="text-sm text-slate-500 hover:text-[#005DAA] py-1">The President's Message</a>
                                <a href="who-are-we.html" class="text-sm text-slate-500 hover:text-[#005DAA] py-1">Who are We?</a>
                                <a href="#" class="text-sm text-slate-500 hover:text-[#005DAA] py-1">Organization</a>
                ...
                <details class="group">
                    ...
                    <div class="flex flex-col pl-4 mt-2 space-y-2 border-l-2 border-slate-100">
                        <a href="index.html#causes" class="text-sm text-slate-600 hover:text-[#005DAA] py-1">The Strategic
                            Axes</a>
                        <a href="#" class="text-sm text-slate-600 hover:text-[#005DAA] py-1">Health</a>
                        <a href="#" class="text-sm text-slate-600 hover:text-[#005DAA] py-1">Food Bank</a>
                        <a href="#" class="text-sm text-slate-600 hover:text-[#005DAA] py-1">Blood Donation</a>
                        <a href="#" class="text-sm text-slate-600 hover:text-[#005DAA] py-1">Medical Thesis Prize</a>
                        <!-- Nested Details for Other Actions -->
                        <details class="group/nested mt-1">
                            <summary
                                class="flex items-center justify-between text-sm text-slate-600 hover:text-[#005DAA] py-1 cursor-pointer list-none">
                                Other Actions
                            ...
                            <div class="flex flex-col pl-4 mt-1 space-y-2 border-l-2 border-slate-100">
                                <a href="#" class="text-sm text-slate-500 hover:text-[#005DAA] py-1">Support for Young
                                    People</a>
                                <a href="#" class="text-sm text-slate-500 hover:text-[#005DAA] py-1">Hope in the
                                    Lead</a>
                                <a href="#" class="text-sm text-slate-500 hover:text-[#005DAA] py-1">Impact Startup
                                    Award</a>
                                <a href="#" class="text-sm text-slate-500 hover:text-[#005DAA] py-1">Fine Craftsmanship
                                    Award</a>
                            </div>
                        </details>
                    </div>
                ...
                <details class="group">
                    ...
                    <div class="flex flex-col pl-4 mt-2 space-y-2 border-l-2 border-slate-100">
                        <a href="index.html#projects" class="text-sm text-slate-600 hover:text-[#005DAA] py-1">All Projects</a>
                        <a href="#" class="text-sm text-slate-600 hover:text-[#005DAA] py-1">Hope in the Lead</a>
                        <a href="#" class="text-sm text-slate-600 hover:text-[#005DAA] py-1">Impact Startup Award</a>
                        <a href="#" class="text-sm text-slate-600 hover:text-[#005DAA] py-1">Fine Craftsmanship
                            Award</a>
                        <a href="#" class="text-sm text-slate-600 hover:text-[#005DAA] py-1">Audience Award</a>
                    </div>
                </details>
                ...
                <a href="index.html#contact" class="text-slate-700 font-medium hover:text-[#005DAA] py-2">Contact</a>
